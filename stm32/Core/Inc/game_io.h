...
/**
 * @brief Submit a new score (usually at game over). If higher than current
 *        high score, it is stored in persistent memory.
 * @param score Score achieved in the just-finished game.
 */
